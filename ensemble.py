...
for fold in range(5):
    for model in modelList:
        jsonFileName = 'folder.'+str(fold)+'.FocalLoss_alpha_0.25.metrics_val_best_weights.json'
    ...
    print(accSum)
    modelWeight = [alexnetCaculAcc,attention56CaculAcc,vgg13CaculAcc,resnet34CaculAcc]/accSum
