...
class InceptionB(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branch3x3 = BasicConv3d(input_channels, 384, kernel_size=3, stride=2)

        self.branch3x3stack = nn.Sequential(
            BasicConv3d(input_channels, 64, kernel_size=1),
            BasicConv3d(64, 96, kernel_size=3, padding=1),
            BasicConv3d(96, 96, kernel_size=3, stride=2)
        )
...
class InceptionV3(nn.Module):
    ...
    def __init__(self, num_classes=2):
        super().__init__()
        self.Conv3d_1a_3x3 = BasicConv3d(1, 32, kernel_size=3, padding=1)
        self.Conv3d_2a_3x3 = BasicConv3d(32, 32, kernel_size=3, padding=1)
        self.Conv3d_2b_3x3 = BasicConv3d(32, 64, kernel_size=3, padding=1)
        self.Conv3d_3b_1x1 = BasicConv3d(64, 80, kernel_size=1)
        self.Conv3d_4a_3x3 = BasicConv3d(80, 192, kernel_size=3)
