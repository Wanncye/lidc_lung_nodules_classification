...
for out_index in range(1):
    ...
    googlenet_train_feature = torch.load('./data/mask_feature/googlenet_train.pt')
    googlenet_test_feature = torch.load('./data/mask_feature/googlenet_test.pt')
    resnet10_train_feature = torch.load('./data/mask_feature/resnet10_train.pt')
    resnet10_test_feature = torch.load('./data/mask_feature/resnet10_test.pt')
    resnet18_train_feature = torch.load('./data/mask_feature/resnet18_train.pt')
    resnet18_test_feature = torch.load('./data/mask_feature/resnet18_test.pt')
    resnet34_train_feature = torch.load('./data/mask_feature/resnet34_train.pt')
    resnet34_test_feature = torch.load('./data/mask_feature/resnet34_test.pt')
    resnet50_train_feature = torch.load('./data/mask_feature/resnet50_train.pt')
    resnet50_test_feature = torch.load('./data/mask_feature/resnet50_test.pt')
    resnet101_train_feature = torch.load('./data/mask_feature/resnet101_train.pt')
    resnet101_test_feature = torch.load('./data/mask_feature/resnet101_test.pt')
    resnet152_train_feature = torch.load('./data/mask_feature/resnet152_train.pt')
    resnet152_test_feature = torch.load('./data/mask_feature/resnet152_test.pt')
    resnet200_train_feature = torch.load('./data/mask_feature/resnet200_train.pt')
    resnet200_test_feature = torch.load('./data/mask_feature/resnet200_test.pt')
    vgg11_train_feature = torch.load('./data/mask_feature/vgg11_train.pt')
    vgg11_test_feature = torch.load('./data/mask_feature/vgg11_test.pt')
    vgg13_train_feature = torch.load('./data/mask_feature/vgg13_train.pt')
    vgg13_test_feature = torch.load('./data/mask_feature/vgg13_test.pt')
    vgg16_train_feature = torch.load('./data/mask_feature/vgg16_train.pt')
    vgg16_test_feature = torch.load('./data/mask_feature/vgg16_test.pt')
    vgg19_train_feature = torch.load('./data/mask_feature/vgg19_train.pt')
    vgg19_test_feature = torch.load('./data/mask_feature/vgg19_test.pt')
    ...
    train_graph = zip(googlenet_train_feature,
                    resnet10_train_feature,resnet18_train_feature,resnet34_train_feature,resnet50_train_feature,resnet101_train_feature,resnet152_train_feature,resnet200_train_feature,
                    vgg11_train_feature,vgg13_train_feature,vgg16_train_feature,vgg19_train_feature)
    test_graph = zip(googlenet_test_feature,
                    resnet10_test_feature,resnet18_test_feature,resnet34_test_feature,resnet50_test_feature,resnet101_test_feature,resnet152_test_feature,resnet200_test_feature,
                    vgg11_test_feature,vgg13_test_feature,vgg16_test_feature,vgg19_test_feature)
    ...
    for epoch in range(100):
        ...
        #训练
        for index, one_nodule_feature in enumerate(train_graph):
        ...
        #测试
        for index, one_nodule_feature in enumerate(test_graph):
            temp = torch.zeros((len(one_nodule_feature),512))
            for i, feature in enumerate(one_nodule_feature):
                temp[i] = feature
